...
If your sample uses Docker Compose here are few tips:
...
* Configure your sample app to use the dynamic host (`YOUR_SVC_HOST`) and port (`YOUR_SVC_PORT`) property (https://github.com/spring-projects/spring-aot-smoke-tests/blob/main/data/data-jdbc-postgresql/src/main/resources/application.properties[example])
