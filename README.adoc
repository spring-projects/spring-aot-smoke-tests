...
To overcome this limitation, this branch contains workflows for every smoke test found in the `3.2.x`, `3.3.x`, `3.4.x`, `3.5.x`, `4.0.x`, and `main` branches.
...
- https://github.com/spring-projects/spring-aot-smoke-tests/tree/3.5.x[3.5.x]
- https://github.com/spring-projects/spring-aot-smoke-tests/tree/4.0.x[4.0.x]
...
Now, create worktrees for the `3.2.x`, `3.3.x`, `3.4.x`, `3.5.x`, `4.0.x`, and `main` branches:
...
git worktree add ../3.5.x 3.5.x
git worktree add ../4.0.x 4.0.x
