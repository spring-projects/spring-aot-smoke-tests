...
public interface AuthorRepository extends ListCrudRepository<Author, Long> {
	...
	// setLockMode(query, LockModeType.PESSIMISTIC_WRITE)
	@Lock(LockModeType.PESSIMISTIC_WRITE)
	@Query("SELECT a FROM Author a WHERE a.name = :name")
	List<Author> findForUpdateByName(String name);
	...
	// getResultList(query), then EntityManager#remove per element
	List<Author> deleteByNameContaining(String fragment);
