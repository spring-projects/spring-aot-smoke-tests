...
To overcome this limitation, this branch contains workflows for every smoke test found in the `3.2.x`, `3.3.x`, `3.4.x`, `3.5.x`, and `main` branches.
...
Now, create worktrees for the `3.2.x`, `3.3.x`, `3.4.x`, `3.5.x`, and `main` branches:
