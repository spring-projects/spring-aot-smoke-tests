...
public class ThymeleafRuntimeHints implements RuntimeHintsRegistrar {
	...
	private static final Set<String> EXPRESSIONS = Set.of("org.thymeleaf.standard.expression.AdditionExpression",
			...
			"org.thymeleaf.standard.expression.LessThanExpression", "org.thymeleaf.standard.expression.LinkExpression",
			"org.thymeleaf.standard.expression.MessageExpression", "org.thymeleaf.standard.expression.MinusExpression",
			...
			"org.thymeleaf.standard.expression.NumberTokenExpression", "org.thymeleaf.standard.expression.OrExpression",
	...
	public void registerHints(RuntimeHints hints, ClassLoader classLoader) {
		...
		hints.reflection().registerType(TypeReference.of("org.thymeleaf.spring6.view.ThymeleafView"),
				hint -> hint.withMembers(MemberCategory.INVOKE_PUBLIC_CONSTRUCTORS));
		hints.reflection().registerType(TypeReference.of("org.thymeleaf.spring6.view.reactive.ThymeleafReactiveView"),
				hint -> hint.withMembers(MemberCategory.INVOKE_PUBLIC_CONSTRUCTORS));
		hints.reflection().registerType(
				TypeReference.of("org.thymeleaf.spring6.expression.Mvc$Spring41MvcUriComponentsBuilderDelegate"),
				hint -> hint.withMembers(MemberCategory.INVOKE_DECLARED_CONSTRUCTORS));
		EXPRESSIONS.forEach(expression -> hints.reflection().registerType(TypeReference.of(expression),
				hint -> hint.withMembers(MemberCategory.INVOKE_DECLARED_CONSTRUCTORS)));
		hints.reflection().registerType(TypeReference.of("org.thymeleaf.engine.IterationStatusVar"),
				hint -> hint.withMembers(MemberCategory.INVOKE_PUBLIC_METHODS));
		hints.reflection().registerType(
				TypeReference.of("org.thymeleaf.extras.springsecurity6.util.Spring6VersionSpecificUtility"),
				hint -> hint.withMembers(MemberCategory.INVOKE_DECLARED_CONSTRUCTORS));
		// TODO: This is used by Thymeleaf but belongs to Spring Security - what to do
		// with it?
		hints.reflection().registerType(
				TypeReference.of("org.springframework.security.authentication.UsernamePasswordAuthenticationToken"),
				hint -> hint.withMembers(MemberCategory.INVOKE_PUBLIC_METHODS));
		hints.reflection().registerType(TypeReference.of("org.springframework.security.core.userdetails.User"),
				hint -> hint.withMembers(MemberCategory.INVOKE_PUBLIC_METHODS));
